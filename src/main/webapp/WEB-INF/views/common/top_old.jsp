...
<head profile="http://gmpg.org/xfn/11">
    ...
    <link rel="stylesheet" href="https://www.ala.org.au/wp-content/themes/ala/style.css" type="text/css"
          media="screen"/>
    <link rel="icon" type="image/x-icon" href="https://www.ala.org.au/wp-content/themes/ala/images/favicon.ico"/>
    <link rel="shortcut icon" type="image/x-icon"
          href="https://www.ala.org.au/wp-content/themes/ala/images/favicon.ico"/>

    <link rel="stylesheet" type="text/css" media="screen"
          href="https://www.ala.org.au/wp-content/themes/ala/css/sf.css"/>
    <link rel="stylesheet" type="text/css" media="screen"
          href="https://www.ala.org.au/wp-content/themes/ala/css/highlights.css"/>
    ...
    <link rel="stylesheet" type="text/css" media="screen"
          href="${pageContext.request.contextPath}/static/styles/styles.css"/>
    <link rel="stylesheet" type="text/css" media="screen"
          href="${pageContext.request.contextPath}/static/styles/demo_table.css"/>
    ...
    <link rel="alternate" type="application/rss+xml" title="Atlas Living Australia NG &raquo; Site Map Comments Feed"
          href="http://www.ala.org.au/support/site-map/feed/"/>
...
<div id="wrapper">
    <c:if test="${empty param.format || param.format != 'minimal'}">
        <ala:bannerMenu returnUrlPath="http://spatial-dev.ala.org.au/actions/dashboard"/>
    </c:if>
